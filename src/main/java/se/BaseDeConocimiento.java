...
public class BaseDeConocimiento {
    ...
    public static RuleInferenceEngine getRules(boolean showRules) {
        ...
        diagnosticoDengue(rie);
        diagnosticoCOVID(rie);
